...
(
  ...
  CONSTRAINT POI_FK_POIZ_BCode FOREIGN KEY (POIZ, BCode) REFERENCES [dbo].BFLOOR(FloorZ, BCode) ON UPDATE CASCADE ON DELETE RESTRICT
);
...
(
  ...
  CONSTRAINT FINGERPRINT_FK_FloorZ_BCode FOREIGN KEY (FloorZ, BCode) REFERENCES [dbo].BFLOOR(FloorZ, BCode) ON UPDATE CASCADE ON DELETE RESTRICT,
